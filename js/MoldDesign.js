...
myApp.directive('donutChart',function(){
	function link(scope,el,attr){
		  ...
		  //************ polygon draw ***************************
		  function drawPoly (objectArray,objectArray2,circleArray){
...
//*******************************************************************		  
		  scope.$watch('data', function(data){
			  // value change korar por type number theke string hoie jai
			  console.log(typeof(data[0]));
			  console.log(data[0]);
			  D_upp_Insert = parseFloat(data [0]);
			  D_upp_Mold = parseFloat(data [1]);
			  H_upp_Mold = parseFloat(data [2]);
			  H_1_upp_Sleeve_1 = parseFloat(data [3]);
			  H_1_upp_Insert = parseFloat(data [4]);
			  D_1_upp_Insert = parseFloat(data [5]);
			  //*******************************************************************
			  //*********************** point declaration *************************
			  //*******************************************************************
			...
			//*******************************************************************
			  ...
			  drawPoly(objectArray,objectArray2,circleArray);	
		  },true);
